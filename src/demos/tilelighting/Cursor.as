package demos.tilelighting 
{
	...
	public class Cursor extends Entity 
	{
		...
		override public function added():void 
		{
			...
			LightWorld(world).lighting.addLight(_light);
		}
		...
		override public function update():void 
		{
			...
			_flooredX = _tileX = Math.floor(world.mouseX / LightWorld.TILE_SIZE);
			_flooredY = _tileY = Math.floor(world.mouseY / LightWorld.TILE_SIZE);
			
			_flooredX *= LightWorld.TILE_SIZE;
			_flooredY *= LightWorld.TILE_SIZE;
		...
		override public function render():void 
		{
			...
			Draw.rectPlus(_flooredX, _flooredY, LightWorld.TILE_SIZE, LightWorld.TILE_SIZE, 0xffffff, 0.8, false, 1);
		}
