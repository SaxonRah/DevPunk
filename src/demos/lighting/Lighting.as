package demos.lighting {
	...
	public class Lighting extends Entity
	{
		...
		public static var minimumDarkness:uint = 0xFF000000;
		...
		public static var blockLights:BitmapData = new BitmapData(Math.ceil(FP.width / grid), Math.ceil(FP.height / grid), true, 0x00000000);
